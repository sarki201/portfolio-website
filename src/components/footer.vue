<template>
  <!-- Footer Container -->
  <div
    class="md:hidden sticky w-full mt-[50px] py-[20px] bg-main-dark border-solid border-t-[3px] border-accent border-opacity-50 z-20 h-full mx-auto max-w-screen-xl"
  >
    <!-- Social Links -->
    <ul class="w-1/3 mx-auto my-[10px] flex flex-row justify-around bg-inherit">
      ...
      <li class="w-[40px] bg-inherit">
        <a
          class="bg-inherit"
          href="https://github.com/sarki201"
          target="”_blank”"
        >
          <svg
            class="fill-main hover:fill-accent bg-inherit"
      ...
      <li class="w-[40px] bg-inherit">
        <a
          class="bg-inherit"
          href="https://www.instagram.com/ual_farouq/"
          target="”_blank”"
        >
          <svg
            class="fill-main hover:fill-accent bg-inherit"
      ...
      <!-- Twitter -->
      <li class="w-[40px] bg-inherit">
        <a class="bg-inherit" href="https://x.com/ual_farouq" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent bg-inherit"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      <li class="w-[40px] bg-inherit">
        <a
          class="bg-inherit"
          href="https://www.linkedin.com/in/umar-sarki/"
          target="”_blank”"
        >
          <svg
            class="fill-main hover:fill-accent bg-inherit"
    ...
    <!-- Signature -->
    <p
      class="w-full mx-auto my-[10px] text-center text-main select-none bg-inherit"
    >
      Built by <span class="bg-inherit hover:text-accent">Umar Usman</span>
      <br />Hosted by <span class="bg-inherit text-accent">Vercel</span>
    </p>
  </div>
