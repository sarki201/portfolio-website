<template>
  ...
  <div class="ssm:h-[50px] h-[120px] lg:h-[175px]">
    <p
      id="text"
      class="ssm:text-[40px] text-[60px] lg:text-[110px] font-extrabold text-accent select-none"
    ></p>
  </div>
</template>
...
function delTypeWriter() {
  ...
  if (text === "") {
    ...
    if (part == greetingArray.length - 1) part = 0;
    else part++;
