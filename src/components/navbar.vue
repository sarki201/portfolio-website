<template>
  ...
  <ul
    v-if="showHiddenDiv"
    class="nav-sm:visible md:hidden flex flex-col h-full w-[70%] justify-center mx-auto text-base bg-main-dark fixed right-0 z-50"
  >
    <!-- Burger Icon -->
    <button
      v-on:click="toggleHidden()"
      class="bg-inherit absolute top-0 right-0 m-10px mr-[15px]"
    >
      <svg
        v-if="!showClose"
        class="bg-inherit fill-main hover:fill-accent z-70"
    ...
    <li class="w-[145px] mx-auto py-5 text-main hover:text-accent bg-inherit">
      <a href="#experience" class="flex flex-col mx-auto bg-inherit">
    ...
    <li class="w-[145px] mx-auto py-2 text-main hover:text-accent bg-inherit">
      <a href="#contact" class="flex flex-col mx-auto bg-inherit">
        <span class="text-accent mx-auto bg-inherit">04. </span>
        <span class="text-main bg-inherit mx-auto hover:text-accent"
          >Contact</span
        >
      </a>
  ...
  >
    ...
    >
      ...
      <!-- Projects -->
      <li class="my-auto mx-1 p-5 text-main hover:text-accent bg-inherit">
        <a href="#experience" class="bg-inherit">
      ...
      <li class="my-auto mx-1 p-5 text-main hover:text-accent bg-inherit">
        <a href="#contact" class="bg-inherit">
          <span class="text-accent bg-inherit">04.</span>
          Contact
        </a>
      </li>
      ...
      <!-- Resume -->
      <li
        class="my-auto mx-1 mr-[20px] p-5 text-main hover:text-accent bg-inherit"
      >
        <form method="get" action="/files/resume.pdf">
          <button
            class="text-accent bg-accent bg-opacity-25 rounded-md px-5 py-1 border-accent border-[2px] hover:scale-105 hover:bg-opacity-0"
    ...
    <button
      v-on:click="toggleHidden()"
      class="nav-sm:visible md:hidden bg-inherit justify-end m-10px mr-[15px]"
    >
      <!-- Open Icon -->
      <svg
        v-if="showClose"
        class="bg-inherit stroke-main hover:stroke-accent"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 30 30"
        width="50px"
        height="50px"
      >
        <path
          class="stroke-main hover:stroke-accent"
          stroke-linecap=""
