  ...
  <div class="nav-sm:hidden fixed mx-45px bottom-0 left-0 z-10">
    ...
    <ul class="my-20px bg-none">
      ...
      <li class="w-50px hover:scale-105">
        <a href="https://github.com/sarki201" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent"
      ...
      <!-- Instagram -->
      <li class="w-50px hover:scale-105">
        <a href="https://www.instagram.com/ual_farouq/" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      <!-- Twitter -->
      <li class="w-50px hover:scale-105">
        <a href="https://twitter.com/ual_farouq" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
      ...
      <!-- LinkedIn -->
      <li class="w-50px hover:scale-105">
        <a href="https://www.linkedin.com/in/umar-sarki/" target="”_blank”">
          <svg
            class="fill-main hover:fill-accent"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
